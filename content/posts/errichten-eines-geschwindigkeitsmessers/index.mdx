...
Des Weiteren wurde noch ein kleiner LCD-Monitor besorgt, um in der Zukunft die gewünschten Daten extrahiert auf dem Motorrad befestigt betrachten zu können.
...
Das Projekt ist noch weiterhin im Gange und die finale Planung wurden noch nicht unternommen, allerdings existiert bereits ein grober Fahrplan.
...
In diesem Beispiel stellen wir uns vor, dass die eine Tabelle mit allen kommenden Daten temporär gefüllt wird und die andere anhand unserer Logik.
